...
-- Schermgrootte, ReleaseDate, MegaPixels
-- **********************************************************************************************
...
VALUES
 ('Apple', 'iPhone 16 Pro', 1257,32,"IOS",6.7,"2024-09-20",50, 1, NULL, SYSDATE(6), SYSDATE(6)),
 ('Samsung', 'Galaxy S25 Ultra',1589.45,64,"Android",4.6,"2025-07-04",200, 1, NULL, SYSDATE(6), SYSDATE(6)),
 ('Google', 'Pixel 9 Pro',1467,128,"Chrome OS",5.5,"2024-04-05",100, 1, NULL, SYSDATE(6), SYSDATE(6));
...
(
    ...
    ,Waterdichtheid     DECIMAL(10, 2)              NOT NULL
...
VALUES
 (1, 'Rolex', 'Daytona 126500LN','Goud',2.1,'2023-04-02',5.2,  19800, 1, NULL, SYSDATE(6), SYSDATE(6)),
 (2, 'Omega', 'Speedmaster Moonwatch Professional','Diamant',2.25,'2023-12-02',4.5, 8500, 1, NULL, SYSDATE(6), SYSDATE(6)),
 (3, 'Vacheron Constantin', 'Overseas Perpetual Calendar Ultra-Thin','RVS',3.35,'2023-11-04',10.25, 98000, 1, NULL, SYSDATE(6), SYSDATE(6)),
 (4, 'Jaeger-LeCoultre', 'Reverso Tribute Duoface','Goud',4.25,'2003-06-02',8.75, 17000, 1, NULL, SYSDATE(6), SYSDATE(6));
...
VALUES
 ...
 ,('Madonna', 575,'Verenigde Staten', '+13425 185876', 64, 1, NULL, SYSDATE(6), SYSDATE(6))
 ,('Taylor Swift', 570,'Verenigde Staten', '+15876 236512', 33, 1, NULL, SYSDATE(6), SYSDATE(6))
 ,('Beyoncé', 420,'Verenigde Staten', '+16794 908465', 41, 1, NULL, SYSDATE(6), SYSDATE(6))
 ,('Jennifer Lopez', 400,'Verenigde Staten', '+13131 857345', 53, 1, NULL, SYSDATE(6), SYSDATE(6));
